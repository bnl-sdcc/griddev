...
class deleteRoleAttributeRequest1:
    def __init__(self):
        ...
        self._in2 = None
        return
deleteRoleAttributeRequest1.typecode = Struct(pname=("http://glite.org/wsdl/services/org.glite.security.voms.service.attributes","deleteRoleAttribute"), ofwhat=[ZSI.TC.String(pname="in0", aname="_in0", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ZSI.TC.String(pname="in1", aname="_in1", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True), ns1.AttributeValue_Def(pname="in2", aname="_in2", typed=False, encoded=None, minOccurs=1, maxOccurs=1, nillable=True)], pyclass=deleteRoleAttributeRequest1, encoded="http://glite.org/wsdl/services/org.glite.security.voms.service.attributes")
