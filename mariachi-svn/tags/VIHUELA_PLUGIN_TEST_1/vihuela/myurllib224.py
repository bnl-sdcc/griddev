...
from urllib import unwrap, unquote, splittype, splithost, addinfourl, splitport, splitgophertype, splitquery, splitattr, ftpwrapper, noheaders, splituser, splitpasswd, splitvalue 
...
class AbstractHTTPHandler(BaseHandler):
    ...
    def do_open(self, http_class, req):
        ...
        # Handle special case of HTTPS, harvest SSL params if set, None by default
        if issubclass(http_class, httplib.HTTPSConnection):
            h = httplib.HTTPSConnection(host,
                                key_file=HTTPSHandler.keyfile, 
                                cert_file=HTTPSHandler.certfile,
                                strict=HTTPSHandler.strict)
