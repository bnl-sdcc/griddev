...
class RadioFile(object):
    ...
    CCCYYMMDDHHU   where CCC is the sitecode and U just means UTC
...
class RadioDataHandler(object):
    ...
    def slicewav(self, radiofile, start=0, duration=5):
        '''
        ...
        import commands
        cmd = "sox %s %s trim %s %s" % (radiofile.path, tmpfilename, start, duration)
