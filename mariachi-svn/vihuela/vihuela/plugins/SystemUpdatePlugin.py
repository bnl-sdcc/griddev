# 
# Vihuela plugin that goes to a remote URL, downloads script(s) and runs them.
# Any scripts used should be idempotent, i.e. it mustn't matter if they are run once,
# or many times--the end state should be the same. 
#
#
#
#
...
class SystemUpdatePlugin(Plugin):
    ...
    def run_action(self):
        try:
            ...
            self.log.warn('vihuela.plugins.SystemUpdatePlugin.run_action(): Caught exception.')
