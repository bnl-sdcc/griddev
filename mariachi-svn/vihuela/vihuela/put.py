...
"""
#
# Borrowed for Vihuela from http://inamidst.com/proj/put/put.py
# Thanks to Sean Palmer.
#
# Modified to use SSL certificates by John Hover
#
#
#
...
def putfile(f, uri, username=None, password=None): 
   ...
   scheme, host, port, path = parseuri(uri)
