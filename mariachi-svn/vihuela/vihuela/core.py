...
class Plugin(threading.Thread):
    ...
    def run(self):
        """
        Catches any exception to be sure that entire program or plugin is not killed. Individual plugins
        should also wrap actions with try-except blocks to do custom error detection and logging. 
        ...
        while not self.stopevent.isSet():
            ...
            try:
                ...
                self.log.warn("%s.run(): [%s] looping..." % (self.klassname, self.section))
