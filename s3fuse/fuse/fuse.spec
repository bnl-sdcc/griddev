...
* Thu Apr  8 2010 Josef Bacik <jbacik@redhat.com> 2.8.3-1
- Rebase to 2.8.3 for bz 577927

* Mon Feb 22 2010 Josef Bacik <jbacik@redhat.com> 2.8.1-5
- Add fuse group and fix fusermount so it can only be executed by people in the fuse group

* Tue Jan 26 2010 Josef Bacik <jbacik@redhat.com> 2.8.1-4
- Fix umount race with symlinks (bz# 558874, CVE-2009-3297)
